...
These are primary or high-value references that match the topics in the study guide.
...
- [Hacking Google video series](https://www.youtube.com/playlist?list=PL590L5WQmH8dsxxz7ooJAgmijwOz0lh2H)
...
- Use NIST for definitions and framework language.
